...
if st.session_state.show_popup:
    st.markdown(
        ...
        <div class="splash-container">
            ...
            <div class="splash-subtitle">Seamless Multilingual Communication</div>
...
# Define the heading color based on the theme
heading_color = "white" if st.session_state.theme == "Ocean" else selected_theme['primary']
...
/* Specific styles for the text you want to change */
.stApp label {{
...
/* Preserve the custom styling for the app title (Vocalite) */
